...
| [vela-app](vela-app/) | A confidential app for Horizen's Vela: the guest with its tests, and a workbench that deploys it and drives it from the browser — register, deposit, encrypted payloads, events, reports. On the public devnet out of the box. | [SYNSEMA/vela-app](https://github.com/SYNSEMA/vela-app) `v0.2.1` |
| [vela-payroll](vela-payroll/) | Private payroll on Vela: a web console where an employer funds, onboards people and runs payroll in a stablecoin; each person's payslips and payouts are one page away. On the public devnet out of the box. | [SYNSEMA/vela-payroll](https://github.com/SYNSEMA/vela-payroll) `v0.2.3` |
