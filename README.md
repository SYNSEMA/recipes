...
| [vela-app](vela-app/) | A confidential app for Horizen's Vela: the guest with its tests, and a workbench that deploys it and drives it from the browser — register, deposit, encrypted payloads, events, reports. On the public devnet out of the box. | [SYNSEMA/vela-app](https://github.com/SYNSEMA/vela-app) `v0.3.0` |
